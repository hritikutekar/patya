...
find -name '*.ko' -type f -exec cp '{}' /home/ubuntu/AnyKernel2/modules/ \;
cp arch/arm/boot/zImage /home/ubuntu/AnyKernel2/
cd /home/ubuntu/AnyKernel2/
zip -r9 /home/ubuntu/HKernel-$today.zip *
}
HKernel
BUILD_END=$(date +"%s")
